...
procedure TEventoCCENFe.Executar;
var
...
begin
  ...
  oEvento.InfEvento.TpEvento := 110110; // TipoEventoNFe.CartaCorrecao ###
  ...
  oEvento.InfEvento.DetEvento := CreateOleObject('Unimake.Business.DFe.Xml.NFe.DetEventoCCE'); //###
  oEvento.InfEvento.DetEvento.Versao := '1.00';
  oEvento.InfEvento.DetEvento.XCorrecao := 'CFOP errada, CFOP correta do produto 10 e 5602';
  ...
  try
    begin
      ...
      nomeArquivoEvento := 'd:\testenfe\CCENFe.xml';
