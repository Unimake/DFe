...
namespace Unimake.DFe.Test.NFCe.Servicos
{
    /// <summary>
    ...
    public class ConsultaCadastroTest
    {
        ...
        [Trait("DFe", "NFCe")]
        [InlineData(UFBrasil.PR, "06117473000150")]
        public void ConsultarCadastroContribuinteNFCeString(UFBrasil ufBrasil, string cnpj)
        {
            var xml = new ConsCad
            {
                Versao = "2.00",
        ...
        [Trait("DFe", "NFCe")]
        [InlineData(UFBrasil.PR, "06117473000150")]
        public void ConsultarCadastroConstrutor (UFBrasil ufBrasil, string cnpj)
        {
            var configuracao = new Configuracao
            {
                TipoDFe = TipoDFe.NFCe,
