...
namespace Unimake.DFe.Test.Utility
{
    ...
    public class NetTest
    {
        ...
        public void WebserviceNFeTest(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
            var webserviceTest = new WebserviceTest
            {
            ...
            var resultTest = webserviceTest.Execute();

            Assert.True(resultTest.Sucess, "Código status do serviço (CStat):" + resultTest.CStat + " - " + resultTest.XMotivo + Environment.NewLine + Environment.NewLine + resultTest.ErrorMessage );
        }
        ...
        [InlineData(UFBrasil.SE, TipoAmbiente.Producao)]
        [InlineData(UFBrasil.TO, TipoAmbiente.Producao)]
        public void WebserviceNFCeTest(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
            var webserviceTest = new WebserviceTest
            {
                TipoAmbiente = tipoAmbiente,
