...
namespace Unimake.DFe.Test.ESocial
{
    ...
    public class SerializacaoDesserealizacaoTest
    {
        ...
        public void SerializacaoDesserializacaoESocial5501(string arqXML)
        {
            ...
            var xml = XMLUtility.Deserializar<Unimake.Business.DFe.Xml.ESocial.ESocial5501>(doc);
            var doc2 = xml.GerarXML();
        ...
        public void SerializacaoDesserializacaoESocial5503(string arqXML)
        {
            ...
            var xml = XMLUtility.Deserializar<Unimake.Business.DFe.Xml.ESocial.ESocial5503>(doc);
            var doc2 = xml.GerarXML();
        ...
        public void SerializacaoDesserializacaoESocial8200(string arqXML)
        {
            ...
            var xml = XMLUtility.Deserializar<Unimake.Business.DFe.Xml.ESocial.ESocial8200>(doc);
            var doc2 = xml.GerarXML();
        ...
        public void SerializacaoDesserializacaoESocialRetornoEnvioLotePositivo(string arqXML)
        {
            Assert.True(File.Exists(arqXML), "Arquivo " + arqXML + " não foi localizado para a realização da serialização/desserialização.");
        ...
        public void SerializacaoDesserializacaoESocialRetornoEnvioLoteErro(string arqXML)
        {
            Assert.True(File.Exists(arqXML), "Arquivo " + arqXML + " não foi localizado para a realização da serialização/desserialização.");
