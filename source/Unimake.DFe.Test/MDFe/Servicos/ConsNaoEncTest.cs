...
namespace Unimake.DFe.Test.MDFe.Servicos
{
    /// <summary>
    ...
    public class ConsNaoEncTest
    {
        ...
        public void ConsultarMDFeNaoEncerrado(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
            ...
            Assert.True(consNaoEnc.Result.CStat.Equals(213) || consNaoEnc.Result.CStat.Equals(203) || consNaoEnc.Result.CStat.Equals(112) || consNaoEnc.Result.CStat.Equals(111), "Serviço não está em operação - <xMotivo>" + consNaoEnc.Result.XMotivo + " - <cStat>" + consNaoEnc.Result.CStat);
        }
        ...
        [Trait("DFe", "MDFe")]
        [InlineData(UFBrasil.PR, TipoAmbiente.Producao)]
        public void ConsultarMDFeNaoEncerradoString(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
            var xml = new ConsMDFeNaoEnc
            {
                Versao = "3.00",
            ...
            var consNaoEnc = new ConsNaoEnc(xml.GerarXML().OuterXml, configuracao);
            consNaoEnc.Executar();
            ...
            //Assert.True(consNaoEnc.Result.CUF.Equals(ufBrasil), "Webservice retornou uma UF e está diferente de " + ufBrasil.ToString());
            Assert.True(consNaoEnc.Result.TpAmb.Equals(tipoAmbiente), "Webservice retornou um Tipo de ambiente diferente " + tipoAmbiente.ToString());
            Assert.True(consNaoEnc.Result.CStat.Equals(203) || consNaoEnc.Result.CStat.Equals(112) || consNaoEnc.Result.CStat.Equals(111) || consNaoEnc.Result.CStat.Equals(213), "Serviço não está em operação - <xMotivo>" + consNaoEnc.Result.XMotivo + "<xMotivo> - <cStat> = " + consNaoEnc.Result.CStat);
        }
        ...
        public void ConsultarMDFeNaoEncerradoCNPJ(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
            ...
            Assert.True(consNaoEnc.Result.CStat.Equals(203) ||
                        ...
                        consNaoEnc.Result.CStat.Equals(213),
                        "Serviço não está em operação - <xMotivo>" + consNaoEnc.Result.XMotivo + "<xMotivo> - <cStat> = " + consNaoEnc.Result.CStat);
        }
