    ...
    public class AutorizacaoTest
    {
        ...
        public void EnviarMDFeAssincrono(UFBrasil ufBrasil, TipoAmbiente tipoAmbiente)
        {
            try
            {
                ...
                Debug.Assert(autorizacao.Result.CStat.Equals(103) || autorizacao.Result.CStat.Equals(203) || autorizacao.Result.CStat.Equals(213), "Lote não foi recebido - <xMotivo> = " + autorizacao.Result.XMotivo);
            }
            catch(Exception ex)
            {
