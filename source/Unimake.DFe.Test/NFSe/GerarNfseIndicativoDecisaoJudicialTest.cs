...
namespace Unimake.DFe.Test.NFSe
{
    ...
    /// </summary>
    public class GerarNfseIndicativoDecisaoJudicialTest
    {
        /// <summary>
        /// Monta o parâmetros, de forma dinâmica, para o cenário de testes
        /// </summary>
        public static IEnumerable<object[]> Parametros => TestUtility.PreparaDadosCenario("GerarNfseIndicativoDecisaoJudicial");
        ...
        public void GerarNfseIndicativoDecisaoJudicial(TipoAmbiente tipoAmbiente, PadraoNFSe padraoNFSe, string versaoSchema, int codMunicipio)
        {
            var nomeXMLEnvio = "GerarNfseEnvio_IndicativoDecisaoJudicial-env-loterps.xml";
