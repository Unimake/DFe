...
public class SerializacaoDesserializacaoNacionalTest
{
    ...
    public void SerializarConsultaEventosNFSe(TipoAmbiente tipoAmbiente, string versaoSchema, int codMunicipio)
    {
        ...
        var servico = new Business.DFe.Servicos.NFSe.ConsultarEvento(xmlDoc, configuracao);
        servico.Executar();
    ...
    public void SerializarConsultarNfsePorRpsNACIONAL(TipoAmbiente tipoAmbiente, string versaoSchema, int codMunicipio, string caminhoXml)
    {
        ...
        var servico = new Business.DFe.Servicos.NFSe.ConsultarNfsePorRps(docCriado, configuracao);
        servico.Executar();
        ...
        Assert.NotEqual(default, resultado.DataHoraProcessamento);
    ...
    public void SerializarConsultarNfseNACIONAL(TipoAmbiente tipoAmbiente, string versaoSchema, int codMunicipio, string caminhoXml)
    {
        ...
        var servico = new Business.DFe.Servicos.NFSe.ConsultarNfse(docCriado, configuracao);
        servico.Executar();
