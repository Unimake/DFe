...
namespace Unimake.Business.DFe.Xml.DCe
{
    ...
    [ProgId("Unimake.Business.DFe.Xml.DCe.ProtDCe")]
    [ComVisible(true)]
#endif
    [Serializable()]
    [XmlRoot("protDCe", Namespace = "http://www.portalfiscal.inf.br/dce", IsNullable = false)]
    public class ProtDCe : XMLBase
    {
        ...
        public bool ShouldSerializeInfFisco() => InfFisco != null;
    }
