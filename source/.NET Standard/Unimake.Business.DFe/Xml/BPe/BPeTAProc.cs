...
namespace Unimake.Business.DFe.Xml.BPeTA
{
    ...
    [ProgId("Unimake.Business.DFe.Xml.BPeTA.BPeTAProc")]
    [ComVisible(true)]
#endif
    [Serializable()]
    [XmlRoot("bpeTAProc", Namespace = "http://www.portalfiscal.inf.br/bpe", IsNullable = false)]
    public class BPeTAProc : XMLBase
    {
        /// <summary>
        /// Versao do leiaute
        /// </summary>
        ...
        /// </summary>
        [XmlIgnore]
        public string NomeArquivoDistribuicao => ProtBPe.InfProt.ChBPe + "-procBPeTA.xml";
