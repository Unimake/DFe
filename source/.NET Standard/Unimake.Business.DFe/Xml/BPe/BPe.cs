...
{
    /// <summary>
    /// BP-e - Bilhete de Passagem Eletronico
    /// </summary>
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.BPe")]
    [ComVisible(true)]
#endif
    [Serializable()]
    [XmlRoot("BPe", Namespace = "http://www.portalfiscal.inf.br/bpe", IsNullable = false)]
    public class BPe : XMLBase
    {
        [XmlElement("infBPe")]
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.Agencia")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.EnderComp")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.EnderAgencia")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.InfBPeSub")]
    [ComVisible(true)]
#endif
    public class InfBPeSub
    {
        ...
        [XmlElement("tpSub")]
        public TipoSubstituicaoBPe TpSub { get; set; }
    }

#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.InfPassagem")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.InfPassageiro")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.InfViagem")]
    [ComVisible(true)]
#endif
    public class InfViagem
    {
        [XmlElement("cPercurso")]
        public string CPercurso { get; set; }

        [XmlElement("xPercurso")]
        public string XPercurso { get; set; }

        [XmlElement("tpViagem")]
        public TipoViagemBPe TpViagem { get; set; }

        [XmlElement("tpServ")]
        public TipoServicoBPe TpServ { get; set; }

        [XmlElement("tpAcomodacao")]
        public TipoAcomodacaoBPe TpAcomodacao { get; set; }

        [XmlElement("tpTrecho")]
        public TipoTrechoBPe TpTrecho { get; set; }
        ...
        public bool ShouldSerializePoltrona() => !string.IsNullOrWhiteSpace(Poltrona);
        public bool ShouldSerializePlataforma() => !string.IsNullOrWhiteSpace(Plataforma);
        public bool ShouldSerializeInfTravessia() => InfTravessia != null;
    }

#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.InfTravessia")]
    [ComVisible(true)]
#endif
    public class InfTravessia
    {
        [XmlElement("tpVeiculo")]
        public TipoVeiculoTravessiaBPe TpVeiculo { get; set; }

        [XmlElement("sitVeiculo")]
        public SituacaoVeiculoTravessiaBPe SitVeiculo { get; set; }
    }

#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.InfValorBPe")]
    [ComVisible(true)]
#endif
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.CompValor")]
    [ComVisible(true)]
#endif
    ...
    public class Imp
    {
        ...
        {
            get => VTotDFe.HasValue ? BPeFormat.Format2(VTotDFe.Value) : null;
        ...
        public bool ShouldSerializeICMSUFFim() => ICMSUFFim != null;
        public bool ShouldSerializeIBSCBS() => IBSCBS != null;
        public bool ShouldSerializeVTotDFeField() => VTotDFe.HasValue;
    }

#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.ICMSUFFim")]
    [ComVisible(true)]
#endif
    public class ICMSUFFim
    {
        ...
        {
            get => BPeFormat.Format2(VBCUFFim);
        ...
        {
            get => BPeFormat.Format2(PFCPUFFim);
        ...
        {
            get => BPeFormat.Format2(PICMSUFFim);
        ...
        {
            get => BPeFormat.Format2(PICMSInter);
        ...
        {
            get => BPeFormat.Format2(VFCPUFFim);
        ...
        {
            get => BPeFormat.Format2(VICMSUFFim);
        ...
        {
            get => BPeFormat.Format2(VICMSUFIni);
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.Pag")]
    [ComVisible(true)]
#endif
    public class Pag
    {
...
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.Card")]
    [ComVisible(true)]
#endif
    public class Card
    {
        ...
        public bool ShouldSerializeNParcelas() => NParcelas > 0;
        public bool ShouldSerializeInfAdCard() => !string.IsNullOrWhiteSpace(InfAdCard);
    }

#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Xml.BPe.InfBPeSupl")]
    [ComVisible(true)]
#endif
    public class InfBPeSupl
    {
        ...
        [XmlElement("boardPassBPe")]
        public string BoardPassBPe { get; set; }

        public bool ShouldSerializeBoardPassBPe() => !string.IsNullOrWhiteSpace(BoardPassBPe);
    }
}
