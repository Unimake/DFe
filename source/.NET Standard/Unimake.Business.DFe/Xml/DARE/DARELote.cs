...
namespace Unimake.Business.DFe.Xml.DARE
{
    ...
    public class Erro
    {
        ...
        public List<MensagensEnvio> Mensagens { get; set; }
#if INTEROP
        ...
        /// </summary>
        /// <param name="item">Elemento</param>
        public void AddMensagens(MensagensEnvio item)
        {
            if (Mensagens == null)
            {
                Mensagens = new List<MensagensEnvio>();
            }
        ...
        public MensagensEnvio GetMensagens(int index)
        {
