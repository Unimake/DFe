...
namespace Unimake.Business.DFe.Xml.DARE
{
    ...
    public class DARE : XMLBase
    {
        ...
        public bool ShouldSerializeCodigoBarras44() => !string.IsNullOrEmpty(CodigoBarra44);
        public bool ShouldSerializeCodigoBarras48() => !string.IsNullOrEmpty(CodigoBarra48);
        ...
        public bool ShouldSerializeUf() => Uf != null && Uf != (UFBrasil)(-1);
