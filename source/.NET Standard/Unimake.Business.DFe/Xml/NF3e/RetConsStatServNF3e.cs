...
namespace Unimake.Business.DFe.Xml.NF3e
{
    ...
    [ProgId("Unimake.Business.DFe.Xml.NF3e.RetConsStatServNF3e")]
    [ComVisible(true)]
#endif
    [XmlRoot("retConsStatServNF3e", Namespace = "http://www.portalfiscal.inf.br/nf3e", IsNullable = false)]
    public class RetConsStatServNF3e : XMLBase
    {
