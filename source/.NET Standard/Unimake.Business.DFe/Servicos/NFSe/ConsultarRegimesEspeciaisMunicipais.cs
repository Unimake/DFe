...
{
    /// <summary>
    /// Consultar regimes especiais municipais do padrão NACIONAL
    /// </summary>
#if INTEROP
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("Unimake.Business.DFe.Servicos.NFSe.ConsultarRegimesEspeciaisMunicipais")]
    [ComVisible(true)]
#endif
    public class ConsultarRegimesEspeciaisMunicipais : ServicoBase
    {
        /// <summary>
        ...
        /// Construtor
        /// </summary>
        public ConsultarRegimesEspeciaisMunicipais() : base()
        { }
        ...
        public ConsultarRegimesEspeciaisMunicipais(int codigoMunicipio, string codigoServico, DateTime competencia, Configuracao configuracao) : base()
        {
            CodigoMunicipio = codigoMunicipio;
            CodigoServico = codigoServico;
            Competencia = competencia;

            var xmlRegimes = CriarXMLRegimesEspeciais();
            Inicializar(xmlRegimes, configuracao);
        }
        ...
        /// <param name="configuracao">Objeto "Configuracoes" com as propriedade necessária para a execução do serviço</param>
        public ConsultarRegimesEspeciaisMunicipais(XmlDocument conteudoXML, Configuracao configuracao) : base()
        {
        ...
        /// <summary>
        /// Cria o XML para consulta de regimes especiais
        /// </summary>
        private XmlDocument CriarXMLRegimesEspeciais()
        {
