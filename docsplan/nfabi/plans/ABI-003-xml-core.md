...
> **Manifesto:** docsplan/nfabi/plans/manifests/ABI-003.json
...
Eventos, configuração SOAP, endpoint, produtos consumidores externos e refatoração de tipos compartilhados não exigida.
...
|---:|---|---|---:|---|---|
| 1 | build DLL + execução direta da classe de serialização NFeABI | ENV-DLL | 15 min | round-trip InnerText, XPath e chave 44 dígitos verdes | docsplan/nfabi/plans/evidence/ABI-003/evidence/validation.txt |
...
- Pasta: docsplan/nfabi/plans/evidence/ABI-003/.
