...
> **Manifesto:** docsplan/nfabi/plans/manifests/ABI-002.json
...
Modelo OO completo, serviços SOAP, endpoints de produção e qualquer produto consumidor externo à DLL.
...
|---:|---|---|---:|---|---|
| 1 | build DLL + classe focada de validação NFeABI | ENV-DLL | 15 min | build verde e XSDs/fixtures validados | docsplan/nfabi/plans/evidence/ABI-002/evidence/validation.txt |
...
- Pasta: docsplan/nfabi/plans/evidence/ABI-002/.
