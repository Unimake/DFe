...
Retrabalho restrito a `docsplan/nfabi/` e `.agents/`. Nenhum arquivo de produto, teste de produto, schema incorporado, endpoint de produção ou integração UniNFe foi alterado.
...
- Inventário reproduzível: `docsplan/nfabi/plans/evidence/ABI-000/evidence/SOURCE-SNAPSHOT.md`.
