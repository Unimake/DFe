# ABI-003 - Integridade da fonte e dos schemas
...
| Conjunto | Arquivos | Snapshot aprovado | Snapshot ABI-003 Check | Resultado |
|---|---:|---|---|---|
...
Os 22 hashes individuais coincidem com `docsplan/nfabi/plans/evidence/ABI-000/evidence/SOURCE-SNAPSHOT.md`. Os schemas embutidos pela ABI-002 permaneceram inalterados durante a ABI-003.
