# Revisão de escopo exclusivo da DLL - ABI-001 attempt-0002
...
A busca case-insensitive pelo nome do produto retirado e pelo identificador legado do ambiente integrado retornou zero ocorrência no plano ativo. Permanecem somente referências históricas em snapshots/dossiês de tentativas anteriores e instruções gerais do repositório fora do plano NF-e ABI; esses registros não foram reescritos para preservar imutabilidade e contexto histórico.
