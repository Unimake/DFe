...
> **Manifesto:** docsplan/nfabi/plans/manifests/ABI-004.json
> **Orquestrador:** `$abi-004-orchestrator`
...
Recepção remota sem endpoint publicado e qualquer produto consumidor externo à DLL.
...
|---:|---|---|---:|---|---|
| 1 | build DLL + classe focada de eventos NFeABI | ENV-DLL | 15 min | três eventos e retornos validam/round-trip | docsplan/nfabi/plans/evidence/ABI-004/evidence/validation.txt |
...
- Pasta: docsplan/nfabi/plans/evidence/ABI-004/.
