...
| REQ-010 | qualidade final e compatibilidade pública da DLL comprovadas | pedido/DEV | ABI-006 | build, testes NFeABI e revisão API/INTEROP | `docsplan/nfabi/plans/evidence/ABI-006/EVIDENCE.md` | APPROVED |
