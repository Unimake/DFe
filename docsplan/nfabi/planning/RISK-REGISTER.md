...
| RISK-004 | quebra da API pública ou INTEROP da DLL | média | alto | build, teste ou exemplo da DLL falha | preservar padrões públicos e executar testes focados da DLL | reverter membro incompatível | executor | ABI-006 | build e testes da DLL | MITIGATION_DEFINED |
