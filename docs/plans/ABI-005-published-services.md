...
URLs de produção, transporte para serviço não publicado e integração UniNFe.
...
|---:|---|---|---:|---|---|
| 1 | testes offline de configuração + build; smoke homologação opcional/autorizado | ENV-DLL | 15 min | status/autorização resolvem URL correta; produção falha fechada | docs/plans/evidence/ABI-005/evidence/validation.txt |
...
- Pasta: docs/plans/evidence/ABI-005/.
