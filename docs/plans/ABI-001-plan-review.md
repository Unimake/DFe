...
> **Manifesto:** docs/plans/manifests/ABI-001.json
...
1. Confirmar prefixo ABI. 2. Confirmar se consulta/eventos ficam somente como modelos. 3. Confirmar política de API/INTEROP e teste online. 4. Propagar e congelar.
...
|---:|---|---|---:|---|---|
| 1 | `pwsh -NoProfile -File .agents/skills/plan-linter/scripts/test-plan.ps1 -RepositoryRoot .` | ENV-PLAN | 15 min | zero decisão material aberta e linter retorna 0 | docs/plans/evidence/ABI-001/evidence/validation.txt |
...
Plano READY_FOR_EXECUTION somente após aprovação humana; código intocado.

## 17. Dossiê, evidence e retomada

- Pasta: docs/plans/evidence/ABI-001/.
